...
class CommnunityContainerViewController : TabmanViewController {
...
//        firstVC.tabBarContainer = self
    ...
    let firstVC = UIStoryboard.init(name: "Community", bundle: nil).instantiateViewController(withIdentifier: "StoryListViewController") as! StoryListViewController
...
extension CommnunityContainerViewController: PageboyViewControllerDataSource, TMBarDataSource {
