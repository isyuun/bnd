...
class PetModViewController: CommonViewController {
    ...
    private func setCurrInfo() {
        ...
        self.selectedSido = Sido(cdld: Int(petDetailInfo.stdgCtpvCD)!, upCdId: "", cdNm: petDetailInfo.stdgCtpvNm)
        self.selectedSigungu = SggListData(sggCD: petDetailInfo.stdgSggCD, sggNm: petDetailInfo.stdgSggNm)
