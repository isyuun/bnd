//
//  _PetProfileViewController.swift
//  PetTip
//
...
class _PetProfileViewController: PetProfileViewController {
    ...
    let tapGesture = UITapGestureRecognizer(target: _PetProfileViewController.self, action: #selector(handleTap(_:)))
    ...
    let longPressgesture = UILongPressGestureRecognizer(target: _PetProfileViewController.self, action: #selector(longPressDetected(gesture:)))
