...
class SNSJoinViewController: CommonPostViewController {
    ...
    @IBAction func onComplete(_ sender: Any) {
        ...
        petAddViewController.memberData = MemberJoinData(id: memberData.id, pw: memberData.pw, nick: tf_nickNm.text!, method: memberData.method)
