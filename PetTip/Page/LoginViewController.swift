    ...
    private func startKakaoLogin() {
        ...
        if (UserApi.isKakaoTalkLoginAvailable()) {
            ...
            UserApi.shared.loginWithKakaoTalk { oauthToken, error in
                NSLog("[LOG][I][(\(#fileID):\(#line))::\(#function)][\(String(describing: oauthToken))][\(String(describing: error))]")
        ...
        func onKakaoLoginCompleted(_ accessToken: String?) {
            NSLog("[LOG][I][(\(#fileID):\(#line))::\(#function)][\(String(describing: accessToken))]")
            self.stopLoading()
...
extension LoginViewController: NaverThirdPartyLoginConnectionDelegate {
    ...
    func oauth20ConnectionDidFinishRequestACTokenWithAuthCode() {
        ...
        NSLog("[LOG][I][(\(#fileID):\(#line))::\(#function)][\(String(describing: loginInstance))]")
        if loginInstance == nil {
            NSLog("[LOG][E][(\(#fileID):\(#line))::\(#function)][\(String(describing: loginInstance))]")
            return
        }
